...
*
* @work inspired from Yohann Tendero <yohann.tendero@cmla.ens-cachan.fr>
*/
...
/**
* @fn void non_uniformity_correction(float *IMAGE, int w1, int h1,int SIGMA_MIN, int
...
void non_uniformity_correction(float *IMAGE, int w1, int h1,int SIGMA_MIN, int SIGMA_MAX,
                    float DELTA)
{
